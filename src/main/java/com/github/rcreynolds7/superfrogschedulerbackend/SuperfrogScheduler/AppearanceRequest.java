...
// private
    ...
    // public
    public AppearanceRequest(Integer requestId, EventType eventType, String address, LocalDate eventDate, LocalTime startTime, LocalTime endTime, RequestStatus status, String firstName, String lastName, String phone, String email, String title, String nameOfOrg, String description, String specialInstructions, String externalOrgs, String expenses, SuperFrogStudent student, String notAtTCU) {
